       ...
       <div className={styles['home_content-section_send_tweet']}>
            ...
            <div className={styles['home_content-section_send_tweet-flex']}>
                <div className={styles['home_content-section_send_tweet-flex_svg']}>
                    ...
                    <div onClick={()=>setEmojiState(!emojiState)} className={styles['home_content-section_send_tweet-flex_svg-item_wrapper'] }>
                ...
                <div onClick={clickSend} className={styles['home_content-section_send_tweet-button']}>
                Tweet
                </div>
            </div>
            { emojiState ?
