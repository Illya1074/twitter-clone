       ...
       <div className={styles['home_content-section_send_tweet']}>
            <div className={styles['home_content-section_send_tweet-section']}>
                ...
                <div className={styles['home_content-ection_send_tweet-section-input_wrapper']}>
                    {props.placeholderState ? <div className={styles["my-custom-placeholder"]}>What's happening?</div> : null}
                    <ContentEditable placeholder="What's happening?" className={styles['home_content-ection_send_tweet-section-input']} html={props.text} onChange={props.handleChange} />
                </div>
                {/* </div> */}
            </div>
