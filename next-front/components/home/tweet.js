    ...
    return (
        ...
        {tweetInfo ? <div className={styles['home_content-section_tweet']}>
            ...
            <div className={styles['home_content-section_tweet-content']}>
                ...
                <div className={styles['home_content-section_tweet-content_info_title']}>
                    {tweetInfo.authorUsername} 
                </div>
                <div onClick={()=>console.log(tweetInfo)} className={styles['home_content-section_tweet-content_info_sub-title']}>
                    @{tweetInfo.authorUsername.split(' ').join('').toLowerCase()}
                </div>
                </div>
                <div className={styles['home_content-section_tweet-content_message']}>
                    {tweetInfo.content}
                </div>
                <div className={styles['home_content-section_tweet-footer']}>
                    ...
                    <div onClick={likeFunc} className={styles['home_content-section_tweet-footer_item']}>
                        <div className={styles['home_content-section_tweet-footer_item-svg']}>
