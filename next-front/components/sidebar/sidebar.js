    ...
    return (
        <SidebarWrapper>
            <ul className={styles['home_sidebar_list']}>
                ...
                <div className={styles['home_sidebar_list-tweet']}>
                    <div className={styles['home_sidebar_list-tweet_content']}>
                        Tweet
                    </div>
                </div>
            </ul>
